...
# step 4: load table with lon-lat coordinates of observations
...
# step 5: convert lon-lats of obs into Spilhaus x-y, and grid them manually
...
# step 6: (create a single world ocean
